(* OASIS_START *)
(* DO NOT EDIT (digest: f53b277561112b0e7a57ac2dbfc8c5b9) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("relic_bindings", ["bindings"], []); ("relic", ["lib"], [])];
     lib_c = [("relic", "lib", ["lib/relic_wrapper.h"])];
     flags =
       [
          (["oasis_library_relic_bindings_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_bindings_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_bindings_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_library_relic_bindings_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_bindings_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_library_relic_bindings_native";
              "ocaml";
            ...
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S [A "-ccopt"; A "-I"; A "-ccopt"; A "${pkg_ctypes_stubs}"])
            ]);
          (["oasis_library_relic_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lrelic"])]);
          (["oasis_library_relic_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lrelic"])]);
          (["oasis_library_relic_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_relic_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ...
          ([
            ...
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_relic_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_relic_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_relic_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_executable_test_relic_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_relic_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_executable_test_relic_native";
              "ocaml";
